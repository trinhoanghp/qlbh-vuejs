    ...
    <footer class="footer__section bg__black color-scheme-2">
        <div class="container-fluid">
                ...
                <div class="footer__widget footer__widget--width">
                    ...
                    <div class="footer__widget--inner">
                        <div  v-for="st in Settings" :key="st.id">
                           <div v-if=" st.key == 'aboutus_info'" >
                                <p class="footer__widget--desc text-ofwhite mb-20" style="max-width:500px">{{st.value}}</p>
                            </div>
                       </div>
                            ...
                            <ul class="social__shear d-flex">
                                <li class="social__shear--list">
                                    ...
                                    <div v-if=" st.key == 'facebook_info'" >
                                        <a class="social__shear--list__icon" target="_blank" :href="st.value">
                ...
                <div class="footer__widget--menu__wrapper d-flex footer__widget--width">
                    <div class="footer__widget">
                        ...
                        <ul class="footer__widget--menu footer__widget--inner">
                            <li class="footer__widget--menu__list"><router-link class="footer__widget--menu__text" to="/account">My Account</router-link></li>
                            <li class="footer__widget--menu__list"><router-link class="footer__widget--menu__text" to="/cart">Shopping Cart</router-link></li>
                            <li class="footer__widget--menu__list"><router-link class="footer__widget--menu__text" to="/login">Login</router-link></li>
                            <li class="footer__widget--menu__list"><router-link class="footer__widget--menu__text" to="/register">Register</router-link></li>
                            <li class="footer__widget--menu__list"><router-link class="footer__widget--menu__text" to="/checkout">Checkout</router-link></li>
                            
                        </ul>
                    </div>
                    <div class="footer__widget">
                        <h2 class="footer__widget--title text-ofwhite h3">Our Policy
                            <button class="footer__widget--button" aria-label="footer widget button">
                                <svg class="footer__widget--title__arrowdown--icon" xmlns="http://www.w3.org/2000/svg" width="12.355" height="8.394" viewBox="0 0 10.355 6.394">
                                    <path  d="M15.138,8.59l-3.961,3.952L7.217,8.59,6,9.807l5.178,5.178,5.178-5.178Z" transform="translate(-6 -8.59)" fill="currentColor"></path>
                                </svg>
                        ...
                        <ul class="footer__widget--menu footer__widget--inner">
                            <li class="footer__widget--menu__list"><router-link class="footer__widget--menu__text" to="/about">About Us</router-link></li>
                            <li class="footer__widget--menu__list"><router-link class="footer__widget--menu__text" to="/contact">Contact Us</router-link></li>
                            <li class="footer__widget--menu__list"><router-link class="footer__widget--menu__text" to="/shop">Shop</router-link></li>
                            <li class="footer__widget--menu__list"><router-link class="footer__widget--menu__text" to="/blog">Blog</router-link></li>
            ...
            <div class="footer__bottom d-flex justify-content-between align-items-center">
                <div class="text-left">
                <div  v-for="st in Settings" :key="st.id">
                    <div v-if="st.key == 'copyright_info'">
                        <p class="copyright__content text-ofwhite m-0" >{{st.value}} </p>
                    </div>
                 </div>
                </div>
