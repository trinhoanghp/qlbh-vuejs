            ...
            <div class="container">
                ...
                <div class="main__contact--area position__relative">
                    ...
                    <div class="contact__form">
                        ...
                        <form class="contact__form--inner" action="" method="POST" @submit.prevent="onSumit()">
                            <div class="row">
                                <div class="col-lg-6 col-md-6">
                                    <div class="contact__form--list mb-20">
                                        <label class="contact__form--label" for="input1">First Name <span class="contact__form--label__star">*</span></label>
                                        <input class="contact__form--input"  v-model="model.firstName" id="input1" placeholder="Your First Name" type="text">
                                ...
                                <div class="col-lg-6 col-md-6">
                                    <div class="contact__form--list mb-20">
                                        ...
                                        <input class="contact__form--input" v-model="model.lastName" id="input2" placeholder="Your Last Name" type="text">
                                ...
                                <div class="col-lg-6 col-md-6">
                                    <div class="contact__form--list mb-20">
                                        ...
                                        <input class="contact__form--input" v-model="model.phone" name="number" id="input3" placeholder="Phone number" type="number">
                                ...
                                <div class="col-lg-6 col-md-6">
                                    <div class="contact__form--list mb-20">
                                        ...
                                        <input class="contact__form--input" v-model="model.email" name="email" id="input4" placeholder="Email" type="text">
                                ...
                                <div class="col-12">
                                    <div class="contact__form--list mb-15">
                                        ...
                                        <textarea class="contact__form--textarea" v-model="model.message" name="message" id="input5" placeholder="Write Your Message"></textarea>
                                        <span style="color:red"> {{error['message']}}</span> 
                                    </div>
                                </div>
                            </div>
                            <button class="contact__form--btn primary__btn" type="submit">Submit Now</button>  
                            <span class="m-2 text-success">{{sendContact}}</span>
                        </form>
                    </div>
                    <div class="contact__info border-radius-5">
                        <div class="contact__info--items">
                            ...
                            <div class="contact__info--items__inner d-flex">
                                ...
                                <div class="contact__info--content"  v-for="st in Settings" :key="st.id">
                                    <p class="contact__info--content__desc text-white mt-3" v-if="st.key == 'phone_info'"><a href="tel:{{st.value}}">{{st.value}}</a>  </p>
                                </div>
                            </div>
                        </div>
                        <div class="contact__info--items">
                            ...
                            <div class="contact__info--items__inner d-flex">
                                ...
                                <div class="contact__info--content" v-for="st in Settings" :key="st.id">
                                    <p class="contact__info--content__desc text-white mt-3" v-if="st.key == 'email_info'"> <a href="mailto:{{st.value}}">{{st.value}}</a> </p> 
                                </div>
                            </div>
                        </div>
                        <div class="contact__info--items">
                            ...
                            <div class="contact__info--items__inner d-flex">
                                ...
                                <div class="contact__info--content" v-for="st in Settings" :key="st.id">
                                    <p class="contact__info--content__desc text-white" v-if="st.key == 'address_info'"> {{st.value}}</p> 
                                </div>
                            </div>
                        </div>
                        <div class="contact__info--items">
                            ...
                            <ul class="contact__info--social d-flex">
                                <li class="contact__info--social__list">
                                    <div  v-for="st in Settings" :key="st.id">
                                    <div v-if=" st.key == 'facebook_info'" >
                                    <a class="contact__info--social__icon" target="_blank" :href="st.value">
                                ...
                                <li class="contact__info--social__list">
                                    <div  v-for="st in Settings" :key="st.id">
                                    <div v-if=" st.key == 'instagram_info'" >
                                    <a class="contact__info--social__icon" target="_blank" :href="st.value">
  ...
  methods:{
        validate(){
            ...
            if(this.model.firstName == ''){
                this.error['firstname'] = 'Enter your First Name.'
                isValid = false;
            } else if ( this.model.firstName.length < 3){
                this.error['firstname'] = 'First Name must be at least 3 characters long.'
                isValid = false;
            } else if (this.model.firstName.length > 30) {
                this.error['firstname'] = 'First Name must be up to 30 characters long.'
                isValid = false;
            }
            if(this.model.lastName == ''){
                this.error['lastname'] = 'Enter your Last Name.'
                isValid = false;
            } else if ( this.model.lastName.length < 3){
                this.error['lastname'] = 'Last Name must be at least 3 characters long.'
                isValid = false;
            } else if (this.model.lastName.length > 30) {
                this.error['lastname'] = 'Last Name must be up to 30 characters long.'
                isValid = false;
            }
            if(this.model.email == ''){
            ...
            if(this.model.message == ''){
                this.error['message'] = 'Enter your message.'
                isValid = false;
            }
            return    isValid;
        },
      async  onSumit(){
            if(this.validate()){
                ...
                let res = await   axios.post('sendContact',this.model)
                        console.log(res.data);   
                        this.error = [];
                        this.model = [];
                        this.sendContact = 'You send request success!!!';
